...
def courses(term = None):
    ...
    return render_template("course_offerings.html",courseData = classes, courses = True , term = term)
...
def enrollment():
    ...
    courseTitle = request.args.get('title')
...
def user():
    ...
    # User(user_id = 2, first_name = "Ashwin", last_name= "Balasubramaniam", email = "ashwin@uta.com", password = "abcd1234").save()
